...
public class RedisUtil {
	...
	static{
		if (pool == null) {
			...
			String ip=PropertiesUtil.readValue("redisIP");
	...
	public static List lpushx(String key){
		Jedis jedis = null;
		List list=null;
		try {
			jedis = pool.getResource();
			list=ArrayList(jedis.smembers(key)); ;
		} catch (Exception e) {
			pool.returnBrokenResource(jedis);
			e.printStackTrace();
		} finally {
	...
	private static List ArrayList(Set<String> smembers) {
